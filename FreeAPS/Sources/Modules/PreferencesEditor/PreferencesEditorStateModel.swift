...
//            ]
            ...
            sections = [
                ...
                FieldSection(
                    displayName: NSLocalizedString(
                        "autoISF toggles & general Settings", comment: "autoISF General settings"
                    ),
                    fields: xpmToogles
                ),
                FieldSection(
                ...
                FieldSection(
                    displayName: NSLocalizedString("acce_ISF settings", comment: "autoISF Acceleration settings"),
                    fields: xpmAcceISF
                ),
                FieldSection(
                    displayName: NSLocalizedString("bg_ISF settings", comment: "autoISF BG level settings"),
                    fields: xpmBGISF
                ),
                FieldSection(
                    displayName: NSLocalizedString("dura_ISF settings", comment: "autoISF Duration settings"),
                    fields: xpmDuraISF
                ),
                FieldSection(
                    displayName: NSLocalizedString("pp_ISF settings", comment: "autoISF PP settings"),
                    fields: xpmPostPrandial
                ),
                FieldSection(
                    displayName: NSLocalizedString("delta_ISF settings", comment: "autoISF Delta settings"),
                    fields: xpmDeltaISF
                ),
                FieldSection(
                    displayName: NSLocalizedString("SMB Delivery Ratio settings", comment: "autoISF SMB Delivery settings"),
                    fields: xpmSMB
                ),
                FieldSection(
