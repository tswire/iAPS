...
struct Preferences: JSON {
    ...
    var smbDeliveryRatio: Decimal = 0.8
    ...
    var higherISFrangeWeight: Decimal = 0.4
    var lowerISFrangeWeight: Decimal = 0.7
    var deltaISFrangeWeight: Decimal = 0.6
    var postMealISFalways: Bool = true
    var postMealISFweight: Decimal = 0.015
    var postMealISFduration: Decimal = 2.5
    var enableBGacceleration: Bool = true
    var bgAccelISFweight: Decimal = 0.1
    var bgBrakeISFweight: Decimal = 0.3
    var iobThresholdPercent: Decimal = 70
